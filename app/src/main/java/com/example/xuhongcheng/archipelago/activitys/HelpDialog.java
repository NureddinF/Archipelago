...
public class HelpDialog extends Dialog implements View.OnClickListener {
    ...
    public HelpDialog(Context context, int layoutResID, int[] listenedItems) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lp.height = display.getHeight()*4/5; // 设置dialog高度为屏幕的4/5
    ...
    public interface OnCenterItemClickListener {
        ...
        void OnCenterItemClick(HelpDialog dialog, View view);
